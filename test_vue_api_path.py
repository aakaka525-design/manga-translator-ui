...
async def run_translate_single_image_demo():
    ...
    image_path = Path("/Users/xa/Desktop/projiect/manga-translator-ui_副本/manga_translator/server/data/raw/isekai-dragondick-knight-commander/chapter-1/001.jpg")
    output_path = Path("/Users/xa/Desktop/projiect/manga-translator-ui_副本/result/test_vue_api_output.jpg")
