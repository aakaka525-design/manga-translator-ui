...
用法：
    python scripts/diagnostics/vue_api_path_timed.py

可选：运行两次来区分首次模型加载与稳态翻译耗时：
    python scripts/diagnostics/vue_api_path_timed.py --runs 2
"""
import asyncio
import sys
import os
...
async def main():
    ...
    default_output = repo_root / "result/test_timed_output.jpg"
