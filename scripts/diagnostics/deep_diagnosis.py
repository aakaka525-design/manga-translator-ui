...
用法：
    python scripts/diagnostics/deep_diagnosis.py --mode vue   # Vue/API 路径
    python scripts/diagnostics/deep_diagnosis.py --mode qt    # Qt/CLI 路径
"""
...
DEFAULT_IMAGE_PATH = REPO_ROOT / (
    "manga_translator/server/data/raw/"
    "isekai-dragondick-knight-commander/chapter-1/001.jpg"
)
IMAGE_PATH = os.getenv("MANGA_TEST_IMAGE", str(DEFAULT_IMAGE_PATH))
